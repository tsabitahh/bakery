...
public class Main {
  public static void main(String[] args) {
    ...
    if (order == 1) {
      System.out.println("Your order is Honey Bread\n Total: $15");
    }

    if (order == 2) {
      System.out.println("Your order is Chocolate Eclair\n Total: $14.50");
    }

    if (order == 3) {
      System.out.println("Your order is Cinnamon Roll\n Total: $21");
    }

    if (order == 4) {
      System.out.println("Your order is Croissant\n Total: $10");
    }

    if (order == 5) {
      System.out.println("Your order is Egg Tart\n Total: $17.80");
    }
